...
if not open_df.empty:
    ...
    st.info(f"""
    **Executive Summary:**
    The project has a few specific areas of concern. The main bottleneck right now is **{top_issue['Issue']}**, which has a very high Risk Score of {top_issue['Risk Index']}. The main reason for this risk is its **{top_issue['Category']}**. 
